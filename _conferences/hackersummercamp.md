...
---
[DEF CON]({{ '/conferences/defcon/' | relative_url }}), [BSidesLV]({{ '/conferences/bsideslv/' | relative_url }}), and [Black Hat]({{ '/conferences/blackhat/' | relative_url }}), as well as the variety of other conferences that happen consecutively during early August each year have become collectively known as Hacker Summer Camp.
...
11. Herbs & Rye - Steakhouse with cheap steaks, and a large array of appetizers and sides that are gluten free. Try the calamari, its made with rice flour and made in a dedicated fryer!
12. Prime Steakhouse - Another lovely steakhouse, with great gluten-free protocols. They also serve gluten-free molten lava cake that is amazing.
